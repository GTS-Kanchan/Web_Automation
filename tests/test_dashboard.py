"""
MOVED — this file's tests now live at tests/common/test_dashboard.py as part of
...
Verify the new location collects correctly:
    pytest tests/common/test_dashboard.py --collect-only -q

Then delete this file (tests/test_dashboard.py) — it serves no further purpose.
"""
