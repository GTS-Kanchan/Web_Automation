...
# the project owner (the RCS Error Code Report page's default on-screen table columns),
# not a guess and not the CSV/Excel export header list above (which is a
# separate, already-existing concept). See
# constants/rcs_error_code_analytics_ui_headers.py for the full header list and provenance note.
# ══════════════════════════════════════════════════════════════════════════════

@pytest.mark.smoke
def test_ui_default_table_headers_full(error_code_analytics_page):
    """All confirmed default on-screen table column headers for the RCS Error Code Report
