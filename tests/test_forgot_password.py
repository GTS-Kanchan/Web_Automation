"""
MOVED — this file's tests now live at tests/common/test_forgot_password.py as part of
...
Verify the new location collects correctly:
    pytest tests/common/test_forgot_password.py --collect-only -q

Then delete this file (tests/test_forgot_password.py) — it serves no further purpose.
"""
