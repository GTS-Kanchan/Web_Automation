...
from constants.sms_usage_report_ui_headers import EXPECTED_SMS_USAGE_REPORT_UI_HEADERS
...
# the project owner (the SMS Usage Report page's default on-screen table columns),
# not a guess and not the CSV/Excel export header list above (which is a
# separate, already-existing concept). See
# constants/sms_usage_report_ui_headers.py for the full header list and provenance note.
# ══════════════════════════════════════════════════════════════════════════════

@pytest.mark.smoke
def test_ui_default_table_headers_full(usage_report_page):
    """All confirmed default on-screen table column headers for the SMS Usage Report
