"""
MOVED — this file's tests now live at tests/common/test_contacts_flow.py as part of
...
Verify the new location collects correctly:
    pytest tests/common/test_contacts_flow.py --collect-only -q

Then delete this file (tests/test_contacts_flow.py) — it serves no further purpose.
"""
