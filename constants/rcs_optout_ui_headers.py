"""constants/rcs_optout_ui_headers.py — single source of truth for the RCS Optout Numbers
...
EXPECTED_RCS_OPTOUT_UI_HEADERS from here everywhere the RCS Optout Numbers page's
...
EXPECTED_RCS_OPTOUT_UI_HEADERS = [
    "Action",
    "Phone Number",
    "Opted Out At",
]
