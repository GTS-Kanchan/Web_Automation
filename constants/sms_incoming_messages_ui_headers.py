"""constants/sms_incoming_messages_ui_headers.py — single source of truth for the SMS Incoming Messages
...
EXPECTED_SMS_INCOMING_MESSAGES_UI_HEADERS from here everywhere the SMS Incoming Messages page's
...
EXPECTED_SMS_INCOMING_MESSAGES_UI_HEADERS = [
    "Action",
    "Campaign Name",
    "Sender ID",
    "Country Code",
