"""constants/sms_usage_report_ui_headers.py — single source of truth for the SMS Usage Report
...
EXPECTED_SMS_USAGE_REPORT_UI_HEADERS from here everywhere the SMS Usage Report page's
...
EXPECTED_SMS_USAGE_REPORT_UI_HEADERS = [
    "duration",
    "Total Count",
    "Submitted Count",
    "Delivered Count",
