"""constants/rcs_campaign_analytics_ui_headers.py — single source of truth for the RCS Campaign Analytics
...
EXPECTED_RCS_CAMPAIGN_ANALYTICS_UI_HEADERS from here everywhere the RCS Campaign Analytics page's
...
EXPECTED_RCS_CAMPAIGN_ANALYTICS_UI_HEADERS = [
    "Action",
    "duration",
    "Product",
    "Agent",
