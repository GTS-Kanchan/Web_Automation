"""constants/rcs_campaign_ui_headers.py — single source of truth for the RCS Campaigns
...
EXPECTED_RCS_CAMPAIGN_UI_HEADERS from here everywhere the RCS Campaigns page's
...
EXPECTED_RCS_CAMPAIGN_UI_HEADERS = [
    "Action",
    "Campaign Name",
    "Type",
    "Template",
