"""constants/rcs_agent_analytics_ui_headers.py — single source of truth for the RCS Agent Analytics
...
EXPECTED_RCS_AGENT_ANALYTICS_UI_HEADERS from here everywhere the RCS Agent Analytics page's
...
EXPECTED_RCS_AGENT_ANALYTICS_UI_HEADERS = [
    "duration",
    "Product",
    "Agent",
    "Total Count",
