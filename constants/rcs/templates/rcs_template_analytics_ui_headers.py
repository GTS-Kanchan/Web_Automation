"""constants/rcs_template_analytics_ui_headers.py — single source of truth for the RCS Template Analytics
...
EXPECTED_RCS_TEMPLATE_ANALYTICS_UI_HEADERS from here everywhere the RCS Template Analytics page's
...
EXPECTED_RCS_TEMPLATE_ANALYTICS_UI_HEADERS = [
    "duration",
    "Product",
    "Agent",
    "Template Name",
