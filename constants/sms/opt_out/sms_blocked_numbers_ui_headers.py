"""constants/sms_blocked_numbers_ui_headers.py — single source of truth for the SMS Blocked Number
...
EXPECTED_SMS_BLOCKED_NUMBERS_UI_HEADERS from here everywhere the SMS Blocked Number page's
...
EXPECTED_SMS_BLOCKED_NUMBERS_UI_HEADERS = [
    "Action",
    "Phone Number",
    "Created at",
]
