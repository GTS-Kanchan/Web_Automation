"""constants/sms_campaign_report_ui_headers.py — single source of truth for the SMS Campaign Report
...
EXPECTED_SMS_CAMPAIGN_REPORT_UI_HEADERS from here everywhere the SMS Campaign Report page's
...
EXPECTED_SMS_CAMPAIGN_REPORT_UI_HEADERS = [
    "Action",
    "duration",
    "Campaign Name",
    "Sender",
