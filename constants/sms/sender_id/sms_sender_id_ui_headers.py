"""constants/sms_sender_id_ui_headers.py — single source of truth for the SMS Sender ID
...
EXPECTED_SMS_SENDER_ID_UI_HEADERS from here everywhere the SMS Sender ID page's
...
EXPECTED_SMS_SENDER_ID_UI_HEADERS = [
    "Action",
    "Sender id",
    "Status",
    "Type",
