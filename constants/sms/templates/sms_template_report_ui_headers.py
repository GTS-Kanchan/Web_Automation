"""constants/sms_template_report_ui_headers.py — single source of truth for the SMS Template Report
...
EXPECTED_SMS_TEMPLATE_REPORT_UI_HEADERS from here everywhere the SMS Template Report page's
visible table header labels need verifying:

    from constants.sms_template_report_ui_headers import EXPECTED_SMS_TEMPLATE_REPORT_UI_HEADERS
...
EXPECTED_SMS_TEMPLATE_REPORT_UI_HEADERS = [
    "duration",
    "Template Name",
    "DLT Template ID",
    "Product",
