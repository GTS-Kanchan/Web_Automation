"""constants/sms_template_ui_headers.py — single source of truth for the SMS Template
...
EXPECTED_SMS_TEMPLATE_UI_HEADERS from here everywhere the SMS Template page's
...
EXPECTED_SMS_TEMPLATE_UI_HEADERS = [
    "Action",
    "Template Name",
    "Sender id",
    "DLT Template Id",
