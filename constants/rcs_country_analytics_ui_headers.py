"""constants/rcs_country_analytics_ui_headers.py — single source of truth for the RCS Country Analytics
...
EXPECTED_RCS_COUNTRY_ANALYTICS_UI_HEADERS from here everywhere the RCS Country Analytics page's
...
EXPECTED_RCS_COUNTRY_ANALYTICS_UI_HEADERS = [
    "duration",
    "Product",
    "Agent",
    "Country Code",
