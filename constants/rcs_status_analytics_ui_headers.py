"""constants/rcs_status_analytics_ui_headers.py — single source of truth for the RCS Status Analytics
...
EXPECTED_RCS_STATUS_ANALYTICS_UI_HEADERS from here everywhere the RCS Status Analytics page's
...
EXPECTED_RCS_STATUS_ANALYTICS_UI_HEADERS = [
    "duration",
    "Product",
    "Agent",
    "Status",
