"""constants/rcs_message_type_analytics_ui_headers.py — single source of truth for the RCS Message Type Analytics
...
EXPECTED_RCS_MESSAGE_TYPE_ANALYTICS_UI_HEADERS from here everywhere the RCS Message Type Analytics page's
...
EXPECTED_RCS_MESSAGE_TYPE_ANALYTICS_UI_HEADERS = [
    "duration",
    "Product",
    "Agent",
    "Message Type",
