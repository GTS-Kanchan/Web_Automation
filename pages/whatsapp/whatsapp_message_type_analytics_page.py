...
class WhatsappMessageTypeAnalyticsPage(BasePage):

    REPORT_URL = "/whatsapp/analytics/message-type"
    TABLE_NAME = "whatsapp_message_type_report"

    COLUMN_INDEX = {
        "duration": 0, "product": 1, "waba_number": 2, "message_type": 3,
    ...
    PAGE_TITLE = "xpath=//h1[contains(normalize-space(.),'Message Type Analytics')]"

    DATE_RANGE_PICKER = "#whatsapp-message-type-date-range-picker"
    REPORT_TYPE_SELECT = "#whatsapp-message-type-report-type-select"
    GROUP_BY_LABEL = "#whatsapp-message-type-dimension-multiselect-label"
    GROUP_BY_BUTTON = (
        "xpath=//span[@id='whatsapp-message-type-dimension-multiselect-label']/ancestor::button[1]"
    )
    GROUP_BY_DROPDOWN = "#whatsapp-message-type-dimension-multiselect-dropdown"
    ...
    def is_report_page(self):
        ...
        return "/whatsapp/analytics/message-type" in url and "login" not in url.lower()
